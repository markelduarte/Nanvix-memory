...
/* Program flags. */
#define RM_REC   001     /* Remove contents of directory */
...
static struct
{
	char *filename; /* File or directory. */
	int flags;  /* Flags.             */
} args = { NULL, 0 };
...
static void usage(void)
{
	...
	printf("  -r Remove contents of directory, recursively\n");
